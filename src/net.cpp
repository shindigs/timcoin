...
static const char *strMainNetDNSSeed[][2] = {
    {"timcointools.com", "dnsseed.timcointools.com"},
    {"timcoinpool.org", "dnsseed.timcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"timcointools.com", "testnet-seed.timcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. timcoin is probably already running."), addrBind.ToString().c_str());
        else
